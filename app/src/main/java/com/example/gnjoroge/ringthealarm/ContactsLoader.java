...
//A cursor is used to get the contacts with phone number and each contact is exploded, if it has multiple phone numbers.
...
//The addContacts() will update the contactsList, apply any existing filters and then update the ListView.
